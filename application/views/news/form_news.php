...
<?php echo form_open_multipart('news/add', 'class="form form-horizontal"'); ?>
    ...
    <?php endforeach; ?>
        ...
        <div class="form-group">
            <div class="col-md-offset-3 col-md-6">
                <?php echo form_submit('news/add', $this->lang->line('form_news_create'), 'class="btn btn-lg btn-primary btn-block"'); ?>
            </div>
        </div>
    </fieldset>
