...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo form_open('account/reset_password', 'class="form-horizontal"'); ?>
        ...
        <div class="form-group">
            <div class="col-sm-offset-1 col-md-10">
                <?php echo form_submit('account/reset_password', $this->lang->line('form_reset_password_submit'), 'class="btn btn-success form-control"'); ?>
            </div>
        </div>
