...
<fieldset>
    ...
    <div><?php echo form_submit('account/signin', $this->lang->line('form_signin_submit'), 'class="btn btn-success btn-block"'); ?></div>
...
<br />
<div>
    <a href="<?php echo base_url('account/register') ?>" class="btn btn-primary2 btn-block">
