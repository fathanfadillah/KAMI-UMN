        ...
        'lname' => array(
            ...
            'control' => array(
                array(
                    ...
                    'selected' => set_value('faculty', isset($faculty) ? $faculty : 'Information Communication and Technology'),
                )
            )
        ),'subject_area' => array(
            ...
            'control' => array(
                array(
                    ...
                    'selected' => set_value('subject_area', isset($subject_area) ? $subject_area : 'Teknik Informatika'),
                )
            )
        ),
        'student_id' => array(
        ...
        ,'password' => array(
            ...
            'control' => array(
                array(
                    ...
                    'value' => set_value('password', isset($password) ? $password : ''),
                )
            )
        )
        ,'passconf' => array(
            ...
            'control' => array(
                array(
                    ...
                    'value' => set_value('passconf', isset($passconf) ? $passconf : ''),
                )
            )
        )
    );
...
<?php echo form_open_multipart('account/register', 'class="form form-horizontal"'); ?>
    ...
    <?php endforeach; ?>
        ...
        <div class="form-group">
            <div class="col-md-offset-3 col-md-6">
                <?php echo form_submit('account/request', $this->lang->line('form_profile_submit_create'), 'class="btn btn-lg btn-primary btn-block"'); ?>
            </div>
        </div>
    </fieldset>
