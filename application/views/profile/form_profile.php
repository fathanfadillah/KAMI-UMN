...
<p>
<?php echo form_open_multipart('profile/edit', 'class="form form-horizontal"'); ?>

    <fieldset>

        <div class="form-group">
            <label class="col-md-3 control-label"><?php echo $this->lang->line('form_profile_label_photo'); ?></label>
            <div class="col-md-8">
    ...
    <?php endforeach; ?>
        ...
        <div class="form-group">
            <div class="col-md-offset-3 col-md-6">
                <?php echo form_submit('profile/edit', $this->lang->line('form_profile_submit'), 'class="btn btn-lg btn-primary btn-block"'); ?>
            </div>
        </div>
    </fieldset>
